...
text-align: left;
    ...
    <body>
          <div class="header">
            <h2 align="center"> Намерена е въведената специалност !</h2>
 ...
 <form action="#" method="POST">
    ...
    if (!empty($_POST['Name'])) {
        ...
        $Id=$_SESSION['Specialty'];
      
        
        if (!mysqli_query($dbConn,"UPDATE Specialty "
                . "SET SP_Name ='$Name' "
                . "WHERE SP_Id = $Id ")) {  die("<ul><li>Не могат да се редактират данните</li><li><a href='index.php'>Начало</a></li></ul>! ");
